  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        { id: 'dashboard' as TabType, label: t('nav.dashboard'), icon: BarChart3 },
        { id: 'funds' as TabType, label: t('nav.funds'), icon: Building2 },
        { id: 'classes' as TabType, label: t('nav.classes'), icon: Layers },
        { id: 'accounts' as TabType, label: t('nav.accounts'), icon: Wallet },
        { id: 'nav' as TabType, label: t('nav.nav'), icon: TrendingUp },
        { id: 'transactions' as TabType, label: t('nav.transactions'), icon: ArrowRightLeft },
      ],
    },
    {
      label: t('navGroups.operations'),
      items: [
        { id: 'capital_calls' as TabType, label: t('nav.capitalCalls'), icon: Bell },
        { id: 'distributions' as TabType, label: t('nav.distributions'), icon: DollarSign },
        { id: 'redemptions' as TabType, label: t('nav.redemptions'), icon: ArrowUpCircle },
        { id: 'fees' as TabType, label: t('nav.fees'), icon: Percent },
        { id: 'exchange' as TabType, label: t('nav.exchange'), icon: ShoppingCart },
      ],
    },
    {
      label: t('navGroups.reporting'),
      items: [
        { id: 'statements' as TabType, label: t('nav.statements'), icon: Receipt },
        { id: 'performance' as TabType, label: t('nav.performance'), icon: PieChart },
        { id: 'reports' as TabType, label: t('nav.reports'), icon: FolderOpen },
        { id: 'tax_docs' as TabType, label: t('nav.taxDocs'), icon: FileCheck },
      ],
    },
    {
      label: t('navGroups.advanced'),
      items: [
        { id: 'waterfall' as TabType, label: t('nav.waterfall'), icon: Calculator },
        { id: 'carried_interest' as TabType, label: t('nav.carriedInterest'), icon: Coins },
        { id: 'side_pockets' as TabType, label: t('nav.sidePockets'), icon: Package },
      ],
    },
    {
      label: t('navGroups.crm'),
      items: [
        { id: 'contacts' as TabType, label: t('nav.contacts'), icon: Contact },
        { id: 'onboarding' as TabType, label: t('nav.onboarding'), icon: UserCheck },
        { id: 'clients' as TabType, label: t('nav.clients'), icon: Users },
      ],
    },
    {
      label: t('navGroups.communications'),
      items: [
        { id: 'email' as TabType, label: t('nav.email'), icon: Inbox },
        { id: 'newsletters' as TabType, label: t('nav.newsletters'), icon: Mail },
        { id: 'communications' as TabType, label: t('nav.communications'), icon: MessageSquare },
        { id: 'invitation_templates' as TabType, label: 'Invitation Templates', icon: UserPlus },
        { id: 'email_templates' as TabType, label: 'Email Templates', icon: FileText },
        { id: 'community' as TabType, label: t('nav.community'), icon: Globe },
      ],
    },
    {
      label: t('navGroups.agents'),
      items: [
        { id: 'ai_agents' as TabType, label: t('nav.aiAgents'), icon: Bot },
        { id: 'voice_setup' as TabType, label: t('nav.voiceSetup'), icon: Settings },
        { id: 'voice_live' as TabType, label: t('nav.voiceLive'), icon: Phone },
        { id: 'voice_dialer' as TabType, label: t('nav.voiceDialer'), icon: PhoneCall },
        { id: 'voice_analytics' as TabType, label: t('nav.voiceAnalytics'), icon: BarChart2 },
      ],
    },
    {
