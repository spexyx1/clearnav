...
import { Search, Plus, Mail, Phone, CreditCard as Edit, Trash2, Filter, Download } from 'lucide-react';
                ...
                {filteredContacts.length === 0 ? (
                  ...
                  filteredContacts.map((contact) => (
                    <tr key={contact.id} className="hover:bg-slate-800/30 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-slate-300">{(Array.isArray(contact.staff_accounts) ? contact.staff_accounts[0]?.full_name : contact.staff_accounts?.full_name) || 'Unassigned'}</div>
                      </td>
