...
type SubTab = 'overview' | 'invoices';

// Lazy-load the full tenant invoice manager
...
export default function BillingOverview() {
  ...
  useEffect(() => {
    if (subTab === 'overview') fetchBillingData();
  }, [subTab]);
  ...
  const subTabs: { id: SubTab; label: string; icon: React.ElementType }[] = [
    { id: 'overview', label: 'Subscription Overview', icon: DollarSign },
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-slate-600 mt-1">Manage subscription billing and client invoicing</p>
      </div>

      {/* Sub-tab navigation */}
      <div className="flex items-center space-x-1 bg-slate-100 rounded-lg p-1 mb-6 w-fit">
