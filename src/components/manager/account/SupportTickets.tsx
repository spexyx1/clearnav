              ...
              <div className="bg-slate-800 rounded-lg border border-slate-700 flex flex-col h-[600px]">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4">
                  {messages.map((message) => (
                    <div
                      key={message.id}
                      className={`flex ${message.user_id === selectedTicket.created_by ? 'justify-end' : 'justify-start'}`}
                    >
                      <div
                        className={`max-w-[80%] rounded-lg p-4 ${
                          message.user_id === selectedTicket.created_by
                      ...
                      >
                        ...
                        <p className={`text-xs mt-2 ${
                          message.user_id === selectedTicket.created_by ? 'text-cyan-200' : 'text-slate-400'
                        }`}>
