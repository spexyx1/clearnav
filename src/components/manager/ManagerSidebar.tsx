  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'vault_docs' as TabType, label: 'Investor Vault', icon: Lock },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'invitation_templates', label: t('nav.invitationTemplates'), icon: UserPlus },
        { id: 'email_templates', label: t('nav.emailTemplates'), icon: FileText },
