...
const CLEARNAV_FAVICON = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='5' fill='%230F1117'/%3E%3Cpolyline points='5%2C23 11%2C14 17%2C19 23%2C9 27%2C13' fill='none' stroke='%230284C7' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E";
...
export default function ClearNAVLandingPage({ onLoginClick }: ClearNAVLandingPageProps) {
  ...
  return (
    <div className="clearnav-site min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
      {/* Navigation */}
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-sky-600 rounded-sm"></div>
            ...
            <div className="flex items-center space-x-6">
              ...
              <button
                ...
                className="px-5 py-2 text-gray-300 hover:text-white transition-all duration-200 font-medium border border-gray-700 hover:border-gray-500 rounded-lg hover:bg-gray-800/50"
              >
                Login
              </button>
              <button
                onClick={navigateToSignup}
                className="px-6 py-2.5 bg-sky-600 text-white rounded-lg hover:bg-sky-500 transition-all font-semibold shadow-lg shadow-sky-600/20 hover:shadow-xl hover:shadow-sky-500/30 transform hover:-translate-y-0.5 active:translate-y-0"
              >
                Start Free Trial
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-6xl font-light text-white mb-6 leading-tight">
              ...
              <span className="block mt-2 font-semibold text-sky-400">
                All-in-One Platform
              </span>
            </h1>
            ...
            <div className="flex justify-center">
              <button
                onClick={navigateToSignup}
                className="group flex items-center space-x-2 px-8 py-4 bg-sky-600 text-white rounded-lg hover:bg-sky-500 transition-all text-lg font-medium shadow-lg shadow-sky-600/25"
              >
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            <div className="p-5 bg-gray-800/40 rounded-lg border border-sky-500/20 hover:border-sky-500/40 transition-all group backdrop-blur-sm">
              <div className="flex items-center justify-center w-10 h-10 bg-sky-500/10 rounded-lg mb-3 group-hover:bg-sky-500/20 transition-colors">
                <Shield className="w-5 h-5 text-sky-400" />
              </div>
              <h3 className="text-base font-bold text-white mb-1">AES-256 Encryption</h3>
              <p className="text-gray-400 text-xs">Bank-grade encryption at rest and in transit</p>
            </div>
            ...
            <div className="p-5 bg-gray-800/40 rounded-lg border border-sky-500/20 hover:border-sky-500/40 transition-all group backdrop-blur-sm">
              ...
              <p className="text-gray-400 text-xs">Complete data separation per fund</p>
            </div>
            ...
            <div className="p-5 bg-gray-800/40 rounded-lg border border-sky-500/20 hover:border-sky-500/40 transition-all group backdrop-blur-sm">
              ...
              <p className="text-gray-400 text-xs">Row-level security with audit logging</p>
            </div>
            ...
            <div className="p-5 bg-gray-800/40 rounded-lg border border-sky-500/20 hover:border-sky-500/40 transition-all group backdrop-blur-sm">
              ...
              <p className="text-gray-400 text-xs">Enterprise security standards</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Features Section */}
      <div id="features" className="py-20 px-6 bg-gray-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="p-8 bg-gray-800/50 rounded-xl border border-gray-700/50 hover:border-sky-500/50 transition-all group"
                >
                  <div className="w-12 h-12 bg-sky-600 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            ...
            {pricing.map((plan, index) => (
              <div
                ...
                className={`p-8 rounded-xl border ${
                  plan.highlighted
                    ? 'bg-gray-800/40 border-sky-500 scale-105'
                    : 'bg-gray-800/30 border-gray-700/50'
                }`}
              >
                {plan.highlighted && (
                  <div className="text-sky-400 text-sm font-semibold mb-4">MOST POPULAR</div>
                )}
      ...
      {/* CTA Section */}
      <div className="py-20 px-6 bg-gray-900/40">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-4">
            <button
              onClick={navigateToSignup}
              className="group inline-flex items-center space-x-2 px-10 py-5 bg-sky-600 text-white rounded-lg hover:bg-sky-500 transition-all text-lg font-medium shadow-lg shadow-sky-600/25"
            >
              <span>Start Free Trial</span>
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button
              ...
              className="inline-flex items-center space-x-2 px-10 py-5 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-all text-lg font-medium border border-gray-700"
            >
            ...
            <div>
              ...
              <div className="space-y-2">
                <a
                  ...
                  className="block text-sm text-gray-400 hover:text-sky-400 transition-colors"
                >
                  View Sales Sheet
                </a>
              </div>
      ...
      {showFAQ && (
        <div className="fixed inset-0 bg-gray-950/90 backdrop-blur-sm flex items-center justify-center z-50 p-6">
          <div className="bg-gray-900 rounded-xl max-w-5xl w-full max-h-[85vh] overflow-y-auto border border-gray-800">
